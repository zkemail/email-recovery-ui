    ...
    <div>
        ...
        <div className='bg-white'>
              ...
              {flow === 'setup' ? (
                ...
                <Box sx={{height:{xs:'270px', md:'250px'}, alignContent: 'center', justifyContent: 'center', marginX: 'auto'}}>
                  <Grid container sx={{paddingX:{xs:'2px', sm:'15px', md:'40px', lg:'40px', xl:'100px'}}}>

                    {/* GNOSIS SAFE */}
                    <Grid item xs={6} padding='20px'>
                      <Box sx={{height:{xs:'270px', md:'250px'},  minWidth:'210px', width:{md:'400px', lg:'500px'}, marginX: 'auto', background:'#FFFFFF', border:'1px solid #DDDDDD', borderRadius:'18px', position:'relative'}}>
                        ...
                        <Typography sx={{color:'#848281', fontWeight:'regular',  fontSize: {xxs:'13px', xs:'13px', sm:'13px', md:'16px'}, paddingBottom:'14px', px:'15px'}}>Copy the link and import into your Safe wallet</Typography>
                        {/* <ConnectWallet /> */}
                        <Box sx={{width:{xs:'180px', md:'210px'}}}  margin='auto'>
                    ...
                    <Grid item xs={6} padding='20px'>
                      <Box sx={{height:{xs:'270px', md:'250px'}, minWidth:'210px', width:{md:'400px', lg:'500px'}, marginX: 'auto', background:'#FFFFFF', border:'1px solid #DDDDDD', borderRadius:'18px', position:'relative'}}>
                        ...
                        <Typography sx={{color:'#848281', fontWeight:'regular', fontSize: {xxs:'13px', xs:'13px', sm:'13px', md:'16px'}, paddingBottom:'14px', px:'15px'}}>Connect to see the test wallet flow</Typography>
                        {/* <ConnectWallet /> */}
                        <Box sx={{width:{xs:'180px', md:'210px'}}} margin='auto'>
                ...
                <Box sx={{height:{xs:'270px', md:'250px'}, minWidth:'210px', width:{xs:'250px', md:'400px', lg:'500px'}, marginX: 'auto', background:'#FFFFFF', border:'1px solid #DDDDDD', borderRadius:'18px', marginY:'25px', paddingX: '40px', position:'relative'}}>
                  ...
                  <Stack  sx={{ width:{xs:'190px', md:'210px'}, marginX: 'auto'}}>
