...
const InputNumber = ({ value, onChange, min = 1, title, message, ...props }) => {
  ...
  return (
    <Box>
      ...
      >
        <Box display="flex" flexDirection="column" ml={1} sx={{marginRight:'5px'}}>
          <IconButton 
            size="small" 
          ...
          >
            <ArrowDownwardRoundedIcon sx={{ padding: '1px', fontSize:'12px' }} />
          </IconButton>
        </Box>
        <TextField
          value={value}
